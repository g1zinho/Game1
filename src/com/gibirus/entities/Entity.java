...
public class Entity {
	...
	public static BufferedImage WEAPON_EN = Game.spritesheet.getSprite(7*16, 48, 16, 16);
	...
	public static BufferedImage ENEMY_EN2 = Game.spritesheet.getSprite(7*16, 16, 16, 16);
	public static BufferedImage ENEMY_FREEDBACK = Game.spritesheet.getSprite(96, 16, 16, 16);
	public static BufferedImage GUN_RIGHT = Game.spritesheet.getSprite(128, 48, 16, 16);
	public static BufferedImage GUN_LEFT = Game.spritesheet.getSprite(128+16, 48, 16, 16);
